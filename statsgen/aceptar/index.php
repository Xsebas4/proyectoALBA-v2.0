...
$id = $_POST['id']; /* el id de la categoria */
    ...
    <div class="tabla">        
        ...
        <table class="">
            ...
            <tbody>
                ...
                WHERE general.fk_evento=($evento->Id_evento) AND cerveza.Pendiente=1 AND general.Juzgado=1 AND categorias.Id_categoria=$id");

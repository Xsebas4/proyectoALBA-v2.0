...
<body>
  ...
  <!-- 5              el de 10 -->
    ...
    <div class="comentarios">
        ...
        /* comentarios */
        $sql=$conexion->query("SELECT * FROM comentarios WHERE fk_general=$ID");
        ...
        $html.="</div>
          ...
          if ($total>=30 and $total<=37) {
            ...
            if($total>=34 && $total<37){
              ...
              $sql=$conexion->query("INSERT INTO cerveza (Medalla) VALUES ('Plata') WHERE Id_cerveza=$datos->fk_cerveza");
